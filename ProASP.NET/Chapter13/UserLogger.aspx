<%@ Page language="c#" Codebehind="UserLogger.aspx.cs" AutoEventWireup="false" Inherits="Chapter13.UserLogger" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:Label id="lblInfo" style="Z-INDEX: 100; LEFT: 20px; POSITION: absolute; TOP: 51px" runat="server"
