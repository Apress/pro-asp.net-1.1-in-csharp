<%@ Page language="c#" Codebehind="DataGrid3_Sorting.aspx.cs" AutoEventWireup="false" Inherits="Chapter10.DataGrid3" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<asp:DataGrid id="Datagrid1" runat="server" AutoGenerateColumns="False" Width="100%" HeaderStyle-Font-Size="10"
				...
				AlternatingItemStyle-Font-Italic="true" AllowSorting="True">
