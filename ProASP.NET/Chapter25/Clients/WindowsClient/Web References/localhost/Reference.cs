...
namespace WindowsClient.localhost {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="Employees ServiceSoap", Namespace="http://www.apress.com/ProASP.NET/")]
    public class EmployeesService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        /// <remarks/>
        public EmployeesService() {
            this.Url = "http://localhost/Chapter25/EmployeesService.asmx";
        }
        ...
        public int GetEmployeesCountError() {
            object[] results = this.Invoke("GetEmployeesCountError", new object[0]);
            return ((int)(results[0]));
        }
        
        /// <remarks/>
        public System.IAsyncResult BeginGetEmployeesCountError(System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("GetEmployeesCountError", new object[0], callback, asyncState);
        }
        
        /// <remarks/>
        public int EndGetEmployeesCountError(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((int)(results[0]));
        }
    }
